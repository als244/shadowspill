...
typedef enum ShadowSpillStatus {
    ...
    SHADOWSPILL_STATUS_INITIAL_SPILL_CAPACITY = 21,
    SHADOWSPILL_STATUS_TASK_INPUT_DEADLOCK = 22,
    SHADOWSPILL_STATUS_TASK_DEVICE_CAPACITY = 23,
    SHADOWSPILL_STATUS_FETCH_DEVICE_CAPACITY = 24,
    SHADOWSPILL_STATUS_EVICT_SPILL_CAPACITY = 25,
    ...
    SHADOWSPILL_STATUS_INVALID_EVICT = 29,
    SHADOWSPILL_STATUS_INVALID_FETCH = 30,
    SHADOWSPILL_STATUS_FINAL_RESIDENCY = 31,
    SHADOWSPILL_STATUS_SIMULATION_INTERNAL_ERROR = 32,
    SHADOWSPILL_STATUS_INVALID_WRITE_BACK = 33,
