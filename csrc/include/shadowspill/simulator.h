...
#define SHADOWSPILL_SIMULATION_INITIAL_SPILL_CAPACITY SHADOWSPILL_STATUS_INITIAL_SPILL_CAPACITY
...
#define SHADOWSPILL_SIMULATION_OFFLOAD_SPILL_CAPACITY SHADOWSPILL_STATUS_OFFLOAD_SPILL_CAPACITY
