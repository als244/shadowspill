...
from shadowspill.profiling.metadata import ProfilingMetadata
...
from shadowspill.task.profiles import ProfilingResult
...
def _forward_report(
    ...
    *,
    ...
    return PlanReport(
        ...
        transfer_bytes_evicted=_transfer_bytes(execution_plan, MemoryActionKind.EVICT),
        transfer_bytes_fetched=_transfer_bytes(execution_plan, MemoryActionKind.FETCH),
        profile_unique_keys=profiles.unique_keys,
        profile_cache_hits=profiles.cache_hits,
        profile_cache_misses=profiles.cache_misses,
        allocation_probe_seeds=profiles.allocation_probe_seeds,
