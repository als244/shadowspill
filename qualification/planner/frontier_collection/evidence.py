...
from qualification.planner.corpus import SavedProgramCase
...
def successful_point_evidence(
    *,
    ...
    tokens_per_step = (
        case.identity.tokens_per_microbatch * case.identity.accumulation_steps
    )
    return {
        "case": {
        ...
        "result": {
            ...
            "throughput": {
                ...
                "tokens_per_second": (
                    tokens_per_step * 1_000_000_000 / simulation.makespan_ns
                ),
            },
            "simulation": {
