...
class ProgramRequest:
    ...
    def tokens_per_step(self) -> int:
        return self.tokens_per_microbatch * self.accumulation_steps

    @property
    def case_id(self) -> str:
        return (
            f"{self.model.name}__tokens-{self.tokens_per_microbatch}__"
            f"sequence-{self.sequence_length}__accumulation-{self.accumulation_steps}"
        )
...
def _model_requests(
    ...
    return tuple(
        ...
        for accumulation_steps in axes.accumulation_steps
    )
